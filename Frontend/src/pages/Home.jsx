      ...
      <div className='bg-cover bg-black'>
        ...
        <div>
          ...
          <div className='bg-slate-200 bg-cover pb-6'>
            <div className='grid grid-cols-1 text-center md:mx-20 md:pt-20 md:pb-5 md:grid md:grid-cols-3 '>
              <div className='md:h-40 md:pt-3 h-32 '>
                <div className='flex ml-28 mt-4'>
                  ...
                  <h1 className='mb-2  md:mb-3 font-bold md:text-xl underline'>
                    India reach
                  </h1>
                </div>
                <div className='p-2'>
                  <p className='font-bold md:text-xl md:font-bold'>  200+ Outlets all over in India </p>
                  <p className=' font-bold md:text-xl md:font-bold'> Number one car rental website in India </p>
              ...
              <div className='md:h-40 md:pt-3 h-32'>
                <div className='flex ml-28 mt-4'>
                  ...
                  <h1 className='mb-3 font-bold md:text-xl underline'>
                    24*7 service
                  </h1>
                </div>
                <div className='p-1'>
                  <p className=' font-bold md:text-xl md:font-bold'>  Any time customer service available </p>
                  <p className='font-bold md:text-xl md:font-bold'> No extra cost </p>
            ...
            <div className='h-56 p-1 bg-cover bg-center md:mx-40 rounded-md md:h-128 opacity-75' style={{ backgroundImage: `url(${Mustang})` }}>
